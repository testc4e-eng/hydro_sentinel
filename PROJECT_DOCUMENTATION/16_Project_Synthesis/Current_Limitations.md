...
Cette page documente current limitations dans le cadre de la section 16 Project Synthesis.
...
Cette page de la section 16 Project Synthesis approfondit current limitations à partir du code réel.
