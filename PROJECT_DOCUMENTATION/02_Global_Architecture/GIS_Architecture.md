...
Cette page documente gis architecture dans le cadre de la section 02 Global Architecture.
...
Cette page de la section 02 Global Architecture approfondit gis architecture à partir du code réel.
