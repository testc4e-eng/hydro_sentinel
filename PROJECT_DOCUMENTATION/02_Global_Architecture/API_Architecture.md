...
Cette page documente api architecture dans le cadre de la section 02 Global Architecture.
...
Cette page de la section 02 Global Architecture approfondit api architecture à partir du code réel.
