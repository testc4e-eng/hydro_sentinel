...
Cette page documente backend architecture dans le cadre de la section 02 Global Architecture.
...
Cette page de la section 02 Global Architecture approfondit backend architecture à partir du code réel.
