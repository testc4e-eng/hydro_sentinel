...
Cette page documente python environment dans le cadre de la section 11 Deployment.
...
Cette page de la section 11 Deployment approfondit python environment à partir du code réel.
