...
Cette page documente hydro meteo sebou dans le cadre de la section 08 Dashboards.



## Lecture dashboard

Les dashboards combinent KPI, carte, vigilance, tableaux critiques et graphiques de synthèse.


## Lecture exécutive

Cette page de la section 08 Dashboards approfondit hydro meteo sebou à partir du code réel.
...
| Bloc | Rôle |
| --- | --- |
| KPIDashboard | indicateurs |
| HydroMap | carte |
| CriticalTable | vigilance |
| UnifiedChart | courbes |
