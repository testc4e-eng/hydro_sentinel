...
Cette page documente pages dans le cadre de la section 04 Frontend.



## Frontend réel

L'interface est une SPA pilotée par des routes, des composants de carte, des tableaux et des graphiques.


## Lecture exécutive

Cette page de la section 04 Frontend approfondit pages à partir du code réel.
...
## Pages présentes mais non routées
