...
Cette page documente functional goals dans le cadre de la section 00 Introduction.
...
Cette page de la section 00 Introduction approfondit functional goals à partir du code réel.
